...
def test_dataframe():
    return pd.read_json(test_dataframe_string())


def test_dataframe_string():
    return ('[{"time": "2023-11-05 17:35:18.484000", "trip_id": 0, "vibration": 0, "latitude": 0.0, "longitude": 0.0, '
